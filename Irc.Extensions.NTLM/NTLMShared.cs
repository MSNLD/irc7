...
namespace Irc.Extensions.NTLM
{
    public class NTLMShared
    {
        ...
        {
            public NTLMShared.NTLMv2BlobStruct DeserializedBlob { get; private set; }
        ...
        public struct NTLMSSPMessageType1
        {
            ...
            public NTLMShared.NTLMSSPSecurityBuffer SuppliedDomain;

            [MarshalAs(UnmanagedType.Struct, SizeConst = 8)]
            public NTLMShared.NTLMSSPSecurityBuffer SuppliedWorkstation;

            [MarshalAs(UnmanagedType.Struct, SizeConst = 8)]
            public NTLMShared.NTLMSSPOSVersion OSVersionInfo;
        }
        ...
        public struct NTLMSSPMessageType2
        {
            ...
            [MarshalAs(UnmanagedType.Struct, SizeConst = 8)]
            public NTLMShared.NTLMSSPSecurityBuffer TargetName;
            ...
            [MarshalAs(UnmanagedType.Struct, SizeConst = 8)]
            public NTLMShared.NTLMSSPSecurityBuffer TargetInformation;
        }
