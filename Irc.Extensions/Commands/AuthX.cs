...
namespace Irc.Extensions.Commands
{
    public class AuthX : Command, ICommand
    {
        ...
        public new void Execute(ChatFrame chatFrame)
        {
            ...
            {
                chatFrame.User.Send(Raw.IRCX_ERR_BADVALUE_906(chatFrame.Server, chatFrame.User, "Only supported on GateKeeper or GateKeeperPassport"));
                return;
            }
            ...
            {
                chatFrame.User.Send(Raw.IRCX_ERR_BADVALUE_906(chatFrame.Server, chatFrame.User, "Could not deserialize nonce string"));
                return;
            }
    ...
    .CreatePackageInstance(packageName, chatFrame.Server.GetCredentialManager());
            ...
            chatFrame.User.Send(Raw.IRCX_INFO(chatFrame.Server, chatFrame.User, $"Set {supportPackage.GetPackageName()} Challenge to: {JsonSerializer.Serialize(jsonReadable)}"));
        }
    }
}
