...
namespace Irc.Extensions.Props.Channel
{
    internal class Creation : PropRule
    {
        ...
        public Creation() : base(ExtendedResources.ChannelPropCreation, EnumChannelAccessLevel.ChatMember, EnumChannelAccessLevel.ChatMember, Resources.GenericProps, string.Empty, true)
        {
