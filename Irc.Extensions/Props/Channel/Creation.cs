...
namespace Irc.Extensions.Props.Channel
{
    internal class Creation : PropRule
    {
        ...
        public Creation() : base(ExtendedResources.ChannelPropCreation, EnumChannelAccessLevel.ChatMember, EnumChannelAccessLevel.None, Resources.GenericProps, Resources.GetEpochNowInSeconds().ToString(), true)
        {
