...
namespace Irc.Extensions.Apollo.Tests
{
    public class GateKeeperTests
    {
        ...
        public void AcceptSecurityContext_V1_Auth_Fails_If_Guid_Exists()
        {
            ...
            string token = $"{gateKeeperToken.Serialize<GateKeeperToken>().ToAsciiString()}";
            ...
            token = $"{gateKeeperToken.Serialize<GateKeeperToken>().ToAsciiString()}{new Guid().ToByteArray().ToAsciiString()}{new Guid().ToByteArray().ToAsciiString()}";
        ...
        public void AcceptSecurityContext_Auth_Fails_If_Guest_And_Guid_Blank()
        {
            ...
            token = $"{gateKeeperToken.Serialize<GateKeeperToken>().ToAsciiString()}{Guid.Parse("e23a3251-b322-8b2b-a34c-c4d0be30c5dd").ToByteArray().ToAsciiString()}{new Guid().ToByteArray().ToAsciiString()}";
        ...
        public void AcceptSecurityContext_V3_Auth_Succeeds_With_IP()
        {
            ...
            token = $"{gateKeeperToken.Serialize<GateKeeperToken>().ToAsciiString()}{Guid.Parse("a8b9a59e-bd4d-411d-7728-4ec15d29282b").ToByteArray().ToAsciiString()}{new Guid().ToByteArray().ToAsciiString()}";
