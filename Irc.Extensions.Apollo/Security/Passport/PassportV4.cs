...
namespace Irc.Extensions.Apollo.Security.Passport
{
    public class PassportV4
    {
        ...
        public PassportCredentials ValidateTicketAndProfile(string ticket, string profile)
        {
            ...
            var ticketExpiry = DateTimeOffset.FromUnixTimeSeconds(ticketIssueUnix).AddSeconds(ticketTtl).ToUnixTimeSeconds();
        ...
        public static void debug(string line) => Console.WriteLine(line);
