...
namespace Core.Ircx
{
    class Raws
    {
        ...
        public static string IRCX_CLOSINGLINK_007_SYSTEMKILL = "ERROR :Closing Link: %n[%s] 007 (Killed by system operator)";
        ...
        public static string IRCX_ERR_OPTIONUNSUPPORTED_555 = ":%h 555 %n %s :Server option for this command is not supported.";
        ...
        public static string IRCX_ERR_EXCEPTION = ":%h 999 %n :%s Oops! Looks like you've hit a snag here, please can you kindly report this.";
                    ...
                    case '%':
                        {
                            ...
                            if (i < Raw.Length)
                            {
                                switch (Raw[i])
                                {
                                    case 's':
                                        {
                                            ...
                                            if (len > 0) { 
                                                ...
                                                output.Append(Data[offsetd++].ToString().Substring(0, len));
                                                remainder -= len;
                                            }
                                            break;
                                        }
                                    ...
                                    case 'x':
                                    {
                                        string value = IData[offseti++].ToString("X");
                                    ...
                                    case 'o':
                                    {
                                        string value = IData[offseti++].ToString("X9");
                                        remainder -= value.Length;
                                        output.Append(value);
                                        break;
                                    }
                                    ...
                                    case 'h':
                                    {
                                        string value = Server.Name.ToString();
                                        remainder -= value.Length;
                                        output.Append(value);
                                        break;
                                    }
                                    case 'n':
                                    {
                                        string value = Client.Name.ToString();
                                        remainder -= value.Length;
                                        output.Append(value);
                                        break;
                                    }
                                    ...
                                    case 'c':
                                    {
                                        string value = Channel.Name.ToString();
                                        remainder -= value.Length;
                                        output.Append(value);
                                        break;
                                    }
