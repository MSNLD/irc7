...
public static class Raw
{
    ...
    public static string RPL_AUTH_SEC_REPLY(Server server, User user)
    {
        return "AUTH %s S :%s";
    }

    public static string RPL_AUTH_SUCCESS(Server server, User user)
    {
        return "AUTH %s * %s %o";
    }

    public static string RPL_JOIN_IRC(Server server, User user, Channel channel)
    {
    ...
    public static string RPL_PART_IRC(Server server, User user, Channel channel)
    {
    ...
    public static string RPL_TOPIC_IRC(Server server, User user, Channel channel)
    {
        return $":{user.Address} TOPIC {channel} :%s";
    }

    public static string RPL_PROP_IRCX(Server server, User user, Channel channel)
    {
        return $":{user.Address} PROP {channel} %s :%s";
    }

    public static string RPL_KICK_IRC(Server server, User user, Channel channel)
    {
    ...
    public static string RPL_CHAN_WHISPER(Server server, User user, Channel channel)
    {
    ...
    public static string RPL_PRIVMSG_CHAN(Server server, User user, Channel channel)
    {
        return $":{user.Address} PRIVMSG {channel} :%s";
    }

    public static string RPL_INVITE(Server server, User user, Channel channel)
    {
    ...
    {
        return $":{server} 001 {user} :Welcome to the %s server {user}";
    }
    ...
    {
        return $":{server} 003 {user} :This server was created %s";
    }
    ...
    public static string IRCX_RPL_MODE_324(Server server, User user, Channel channel)
    {
    ...
    public static string IRCX_RPL_TOPIC_332(Server server, User user, Channel channel)
    {
        return $":{server} 332 {user} {channel} :%s";
    }
    ...
    public static string IRCX_RPL_NAMEREPLY_353(Server server, User user, Channel channel)
    {
        return $":{server} 353 {user}(Server server, User user) => {channel} :%s";
    }

    public static string IRCX_RPL_NAMEREPLY_353X(Server server, User user, Channel channel)
    {
        return $":{server} 353 {user}(Server server, User user) => {channel} :";
    }
    ...
    public static string IRCX_ERR_NOSUCHCHANNEL_403(Server server, User user)
    {
        return $":{server} 403 {user} %s :No such channel";
    }
    ...
    public static string IRCX_ERR_CANNOTSENDTOCHAN_404X(Server server, User user, Channel channel)
    {
        return $":{server} 404 {user} {channel} :Cannot send to channel";
    }

    public static string IRCX_ERR_TOOMANYCHANNELS_405(Server server, User user, Channel channel)
    {
    ...
    public static string IRCX_ERR_UNKNOWNCOMMAND_421(Server server, User user)
    {
        return $":{server} 421 {user} %s :Unknown command";
    }
    ...
    {
        return $":{server} 433 * %s :Nickname is already in use";
    }
    ...
    public static string IRCX_ERR_NOTONCHANNEL_442(Server server, User user)
    {
        return $":{server} 442 {user} %s :You're not on that channel";
    }

    public static string IRCX_ERR_USERONCHANNEL_443(Server server, User user)
    {
        return $":{server} 443 {user} %s %s :is already on channel";
    }
    ...
    public static string IRCX_ERR_NEEDMOREPARAMS_461(Server server, User user)
    {
        return $":{server} 461 {user} %s :Not enough parameters";
    }
    ...
    public static string IRCX_ERR_NOPRIVILEGES_481(Server server, User user, Channel channel)
    {
    ...
    public static string IRCX_ERR_CHANQPRIVSNEEDED_485(Server server, User user, Channel channel)
    {
    ...
    public static string IRCX_RPL_IRCX_800(Server server, User user)
    {
        return $":{server} 800 {user} %d %d %s %d %s";
    }
    ...
    public static string IRCX_ERR_BADVALUE_906(Server server, User user)
    {
        return $":{server} 906 {user} %s :Bad value specified";
    }
    ...
    public static string IRCX_ERR_AUTHENTICATIONFAILED_910(Server server, User user)
    {
        return $":{server} 910 {user} %s :Authentication failed";
    }
    ...
    public static string IRCX_ERR_UNKNOWNPACKAGE_912(Server server, User user)
    {
        return $":{server} 912 {user} %s :Unsupported authentication package";
    }
    ...
    public static string IRCX_ERR_ALREADYONCHANNEL_927(Server server, User user)
    {
        return $":{server} 927 {user} %s :Already in the channel.";
    }

    public static string IRCX_ERR_ALREADYONCHANNEL_927X(Server server, User user, Channel channel)
    {
