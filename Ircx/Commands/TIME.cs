...
namespace Core.Ircx.Commands
{
    class TIME : Command
    {
        ...
        public new COM_RESULT Execute(Frame Frame)
        {
            ...
            Frame.User.Send(Raws.Create(Server: Frame.Server, Client: Frame.User, Raw: Raws.IRCX_RPL_TIME_391, Data: new String8[] { new String8(DateTime.Now.ToString("dddd, MMMM dd, yyyy HH:mm:ss ")), Frame.Server.TimeZone }));
